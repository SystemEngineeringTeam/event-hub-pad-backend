...
INSERT INTO `progress_event` (`user_id`, `event_id`) VALUES
  ...
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 8),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 9),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 3),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 4),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 5),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 6),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 7),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 8),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 9),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 10),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 11),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 12),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 13),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 14),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 15),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 16),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 17),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 18),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 19),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 20),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 21),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 22),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 23),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 24),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 25),
  ((SELECT id FROM user WHERE name = '安藤 杏土'), 26),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 11),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 12),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 13),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 14),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 15),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 16),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 17),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 18),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 19),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 20),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 21),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 22),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 23),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 24),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 25),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 26),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 27),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 28),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 29),
  ((SELECT id FROM user WHERE name = '水谷 祐生'), 30);
